...
token = "EU0u2bLXs919MxBDuqTEowNeSW0KEnnhjY"
...
def __aggregator__(groups):
    ...
    hordes = map(lambda x: x["members"], hordes)
    return list(hordes)
...
def get_dungeon_leaderboards(realm_id):
    ...
    players = list()
    print("Requesting leader boards")
